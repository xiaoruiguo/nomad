...
| `WaitForClientStatusWithToken` | - | `t testing.TB, rpc rpcFn, nodeID string, region string, status string, token ...` | - | [L204](file:///d:/claude/nomad/testutil/wait.go#L204) |
...
| `WaitForJobEvalStatusWithToken` | - | `t testing.TB, rpc rpcFn, job *structs.Job, evalStatus map[string]int, token ...` | `[]*structs.Evaluation` | [L398](file:///d:/claude/nomad/testutil/wait.go#L398) |
