...
> 文件路径：[testutil/tls.go](file:///d:/claude/nomad/testutil/tls.go)
> 总行数：52 行
> 所属包：`testutil`
...
| 方法 | 接收者 | 参数 | 返回值 | 行号 |
|------|--------|------|--------|------|
| `IsValidCertificate` | - | `t *testing.T, caPath string` | `*x509.Certificate` | [L18](file:///d:/claude/nomad/testutil/tls.go#L18) |
| `IsValidSigner` | - | `t *testing.T, keyPath string` | `bool` | [L34](file:///d:/claude/nomad/testutil/tls.go#L34) |
