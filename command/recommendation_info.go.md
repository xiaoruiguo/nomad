...
> 文件路径：[recommendation_info.go](file:///d:/claude/nomad/command/recommendation_info.go)
> 总行数：176 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`recommendation info`**，功能简述：

> Display an individual Nomad recommendation
...
**简述**：`Display an individual Nomad recommendation`
