...
> 文件路径：[node_pool_delete.go](file:///d:/claude/nomad/command/node_pool_delete.go)
> 总行数：91 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`node pool delete`**，功能简述：
...
**命令名**：`node pool delete`

### Synopsis()

**简述**：`Delete a node pool`
