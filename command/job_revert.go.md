...
> 文件路径：[job_revert.go](file:///d:/claude/nomad/command/job_revert.go)
> 总行数：149 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`job revert`**，功能简述：

> Revert to a prior version of the job
...
**简述**：`Revert to a prior version of the job`
