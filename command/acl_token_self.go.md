...
> 文件路径：[acl_token_self.go](file:///d:/claude/nomad/command/acl_token_self.go)
> 总行数：106 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`acl token self`**，功能简述：

> Lookup self ACL token
