...
> 文件路径：[tls_ca_create.go](file:///d:/claude/nomad/command/tls_ca_create.go)
> 总行数：271 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`tls ca create`**，功能简述：

> Create a certificate authority for Nomad
...
**简述**：`Create a certificate authority for Nomad`
