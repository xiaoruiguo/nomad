...
> 文件路径：[operator_snapshot_state.go](file:///d:/claude/nomad/command/operator_snapshot_state.go)
> 总行数：106 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`operator snapshot state`**，功能简述：
