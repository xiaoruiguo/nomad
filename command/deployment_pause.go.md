...
> 文件路径：[deployment_pause.go](file:///d:/claude/nomad/command/deployment_pause.go)
> 总行数：123 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`deployment pause`**，功能简述：
