...
> 文件路径：[sentinel_delete.go](file:///d:/claude/nomad/command/sentinel_delete.go)
> 总行数：85 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`sentinel delete`**，功能简述：

> Delete an existing Sentinel policies
...
**简述**：`Delete an existing Sentinel policies`
