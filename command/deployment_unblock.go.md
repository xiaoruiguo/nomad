...
> 文件路径：[deployment_unblock.go](file:///d:/claude/nomad/command/deployment_unblock.go)
> 总行数：144 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`deployment unblock`**，功能简述：

> Unblock a blocked deployment
...
**简述**：`Unblock a blocked deployment`
