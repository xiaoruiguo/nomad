...
> 文件路径：[scaling_policy.go](file:///d:/claude/nomad/command/scaling_policy.go)
> 总行数：83 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`scaling policy`**，功能简述：

> Interact with Nomad scaling policies
...
**简述**：`Interact with Nomad scaling policies`
