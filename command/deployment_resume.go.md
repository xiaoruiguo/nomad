...
> 文件路径：[deployment_resume.go](file:///d:/claude/nomad/command/deployment_resume.go)
> 总行数：144 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`deployment resume`**，功能简述：
