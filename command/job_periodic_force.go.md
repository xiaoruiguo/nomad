...
> 文件路径：[job_periodic_force.go](file:///d:/claude/nomad/command/job_periodic_force.go)
> 总行数：152 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`job periodic force`**，功能简述：

> Force the launch of a periodic job
...
**简述**：`Force the launch of a periodic job`
