...
> 文件路径：[acl_auth_method.go](file:///d:/claude/nomad/command/acl_auth_method.go)
> 总行数：166 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`acl auth-method`**，功能简述：

> Interact with ACL auth methods
...
**简述**：`Interact with ACL auth methods`
