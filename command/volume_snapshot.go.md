...
> 文件路径：[volume_snapshot.go](file:///d:/claude/nomad/command/volume_snapshot.go)
> 总行数：49 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`snapshot`**，功能简述：

> Interact with volume snapshots
...
**简述**：`Interact with volume snapshots`
