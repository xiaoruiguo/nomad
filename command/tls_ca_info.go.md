...
> 文件路径：[tls_ca_info.go](file:///d:/claude/nomad/command/tls_ca_info.go)
> 总行数：95 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`tls cert info`**，功能简述：

> Show certificate authority information
...
**简述**：`Show certificate authority information`
