...
> 文件路径：[alloc_checks.go](file:///d:/claude/nomad/command/alloc_checks.go)
> 总行数：191 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`alloc checks`**，功能简述：
...
**简述**：`Outputs service health check status information.`
