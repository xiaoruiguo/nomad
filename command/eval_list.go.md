...
> 文件路径：[eval_list.go](file:///d:/claude/nomad/command/eval_list.go)
> 总行数：242 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`eval list`**，功能简述：

> List the set of evaluations processed by Nomad
...
**简述**：`List the set of evaluations processed by Nomad`
