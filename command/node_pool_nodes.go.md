...
> 文件路径：[node_pool_nodes.go](file:///d:/claude/nomad/command/node_pool_nodes.go)
> 总行数：165 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`node pool nodes`**，功能简述：

> Fetch a list of nodes in a node pool
...
**简述**：`Fetch a list of nodes in a node pool`
