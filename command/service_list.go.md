...
> 文件路径：[service_list.go](file:///d:/claude/nomad/command/service_list.go)
> 总行数：185 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`service list`**，功能简述：

> Display all registered Nomad services
...
**简述**：`Display all registered Nomad services`
