...
> 文件路径：[operator_raft.go](file:///d:/claude/nomad/command/operator_raft.go)
> 总行数：65 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`operator raft`**，功能简述：

> Provides access to the Raft subsystem
...
**简述**：`Provides access to the Raft subsystem`
