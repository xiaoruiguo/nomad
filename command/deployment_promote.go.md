...
> 文件路径：[deployment_promote.go](file:///d:/claude/nomad/command/deployment_promote.go)
> 总行数：162 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`deployment promote`**，功能简述：

> Promote canaries in a deployment
...
**简述**：`Promote canaries in a deployment`
