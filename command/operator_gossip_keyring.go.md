...
> 文件路径：[operator_gossip_keyring.go](file:///d:/claude/nomad/command/operator_gossip_keyring.go)
> 总行数：76 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`operator gossip keyring`**，功能简述：
...
**简述**：`Manages gossip layer encryption keys`
