...
> 文件路径：[command/agent/job_endpoint_statuses.go](file:///d:/claude/nomad/command/agent/job_endpoint_statuses.go)
> 总行数：80 行
> 所属包：`agent`
...
| 方法 | 接收者 | 参数 | 返回值 | 行号 |
|------|--------|------|--------|------|
| `JobStatusesRequest` | `s *HTTPServer` | `resp http.ResponseWriter, req *http.Request` | `interface{}, error` | [L16](file:///d:/claude/nomad/command/agent/job_endpoint_statuses.go#L16) |
...
| 文件 | 关系 |
|------|------|
| [job_endpoint_statuses_test.go](file:///d:/claude/nomad/command/agent/job_endpoint_statuses_test.go) | 对应测试文件 |
