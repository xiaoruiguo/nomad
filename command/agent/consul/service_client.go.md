...
> 文件路径：[consul/service_client.go](file:///d:/claude/nomad/command/agent/consul/service_client.go)
> 总行数：2202 行
> 所属包：`consul`
...
```go
	...
	explicitlyDeregisteredServices **ast.IndexExpr
	explicitlyDeregisteredChecks **ast.IndexExpr
	...
	agentServices **ast.IndexExpr
	agentChecks **ast.IndexExpr
...
| 名称 | 值 |
|------|----|
| `sidecarProxyCheckRe` | `*ast.CallExpr` |

## 4. 方法与函数

| 方法 | 接收者 | 参数 | 返回值 | 行号 |
|------|--------|------|--------|------|
| `agentServiceUpdateRequired` | `c *ServiceClient` | `reason syncReason, wanted *api.AgentServiceRegistration, existing *api.Agent...` | `bool` | [L171](file:///d:/claude/nomad/command/agent/consul/service_client.go#L171) |
| `maybeTweakTags` | - | `wanted *api.AgentServiceRegistration, existing *api.AgentService, sidecar *a...` | - | [L210](file:///d:/claude/nomad/command/agent/consul/service_client.go#L210) |
...
| `different` | `c *ServiceClient` | `wanted *api.AgentServiceRegistration, existing *api.AgentService, sidecar *a...` | `bool` | [L248](file:///d:/claude/nomad/command/agent/consul/service_client.go#L248) |
...
| `UpdateWorkload` | `scw *ServiceClientWrapper` | `old *serviceregistration.WorkloadServices, newTask *serviceregistration.Work...` | `error` | [L552](file:///d:/claude/nomad/command/agent/consul/service_client.go#L552) |
...
| `NewServiceClient` | - | `agentAPI AgentAPI, namespacesClient *NamespacesClient, logger hclog.Logger, ...` | `*ServiceClient` | [L764](file:///d:/claude/nomad/command/agent/consul/service_client.go#L764) |
...
| `serviceRegs` | `c *ServiceClient` | `ops *operations, service *structs.Service, workload *serviceregistration.Wor...` | `*serviceregistration.ServiceRegistration, error` | [L1299](file:///d:/claude/nomad/command/agent/consul/service_client.go#L1299) |
...
| `checkRegs` | `c *ServiceClient` | `serviceID string, service *structs.Service, workload *serviceregistration.Wo...` | `[]*api.AgentCheckRegistration, error` | [L1474](file:///d:/claude/nomad/command/agent/consul/service_client.go#L1474) |
...
| `UpdateWorkload` | `c *ServiceClient` | `old *serviceregistration.WorkloadServices, newWorkload *serviceregistration....` | `error` | [L1582](file:///d:/claude/nomad/command/agent/consul/service_client.go#L1582) |
...
| `createCheckReg` | - | `serviceID string, checkID string, check *structs.ServiceCheck, host string, ...` | `*api.AgentCheckRegistration, error` | [L2001](file:///d:/claude/nomad/command/agent/consul/service_client.go#L2001) |
