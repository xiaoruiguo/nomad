...
> 文件路径：[volume_snapshot_delete.go](file:///d:/claude/nomad/command/volume_snapshot_delete.go)
> 总行数：120 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`volume snapshot delete`**，功能简述：
...
**简述**：`Delete a snapshot`

### Name()

**命令名**：`volume snapshot delete`
