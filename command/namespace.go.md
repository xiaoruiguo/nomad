...
> 分析文件：[namespace.go](file:///d:/claude/nomad/command/namespace.go)
> Run 函数数量：1

### 1. *NamespaceCommand.Run

**定义位置**：[L51-L53](file:///d:/claude/nomad/command/namespace.go#L51-L53)

**函数签名**：

```go
func (*NamespaceCommand) Run(args []string) (int) {
    // ...
}
```
