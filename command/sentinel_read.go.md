...
> 文件路径：[sentinel_read.go](file:///d:/claude/nomad/command/sentinel_read.go)
> 总行数：108 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`sentinel read`**，功能简述：

> Inspects an existing Sentinel policies
...
**简述**：`Inspects an existing Sentinel policies`
