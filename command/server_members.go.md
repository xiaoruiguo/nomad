...
> 文件路径：[server_members.go](file:///d:/claude/nomad/command/server_members.go)
> 总行数：261 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`server members`**，功能简述：
...
**简述**：`Display a list of known servers and their status`
