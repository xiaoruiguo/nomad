...
> 文件路径：[acl_policy_delete.go](file:///d:/claude/nomad/command/acl_policy_delete.go)
> 总行数：83 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`acl policy delete`**，功能简述：
...
**简述**：`Delete an existing ACL policy`

### Name()

**命令名**：`acl policy delete`
