...
> 文件路径：[quota_apply.go](file:///d:/claude/nomad/command/quota_apply.go)
> 总行数：454 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`quota apply`**，功能简述：

> Create or update a quota specification
...
**简述**：`Create or update a quota specification`
