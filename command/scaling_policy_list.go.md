...
> 文件路径：[scaling_policy_list.go](file:///d:/claude/nomad/command/scaling_policy_list.go)
> 总行数：193 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`scaling policy list`**，功能简述：
...
**简述**：`Display all Nomad scaling policies`
