...
> 文件路径：[node_pool_jobs.go](file:///d:/claude/nomad/command/node_pool_jobs.go)
> 总行数：163 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`node pool jobs`**，功能简述：

> Fetch a list of jobs in a node pool
...
**简述**：`Fetch a list of jobs in a node pool`
