...
> 文件路径：[service.go](file:///d:/claude/nomad/command/service.go)
> 总行数：44 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`service`**，功能简述：

> Interact with registered services
...
**简述**：`Interact with registered services`
