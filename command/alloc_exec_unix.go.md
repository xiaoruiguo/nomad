...
> 文件路径：[command/alloc_exec_unix.go](file:///d:/claude/nomad/command/alloc_exec_unix.go)
> 总行数：19 行
> 所属包：`command`
...
| 方法 | 接收者 | 参数 | 返回值 | 行号 |
|------|--------|------|--------|------|
| `setupWindowNotification` | - | `ch chan<- os.Signal` | `` | [L16](file:///d:/claude/nomad/command/alloc_exec_unix.go#L16) |
