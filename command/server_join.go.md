...
> 文件路径：[server_join.go](file:///d:/claude/nomad/command/server_join.go)
> 总行数：86 行
> 所属包：`command`
...
该文件实现 Nomad CLI 命令 **`server join`**，功能简述：

> Join server nodes together
