...
| `StartTask` | `d *Driver` | `cfg *drivers.TaskConfig` | `handle *drivers.TaskHandle, network *drivers.DriverNetwo...` | [L432](file:///d:/claude/nomad/drivers/java/driver.go#L432) |
...
| `ExecTaskStreamingRaw` | `d *Driver` | `ctx context.Context, taskID string, command []string, tty bool, stream drive...` | `error` | [L730](file:///d:/claude/nomad/drivers/java/driver.go#L730) |
