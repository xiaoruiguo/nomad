...
| 方法 | 接收者 | 参数 | 返回值 | 行号 |
|------|--------|------|--------|------|
| `RestoreFromArchive` | - | `archive io.Reader, filter *nomad.FSMFilter` | `raft.FSM, *state.StateStore, *raft.SnapshotMeta, error` | [L19](file:///d:/claude/nomad/helper/raftutil/snapshot.go#L19) |
