# cpucompat_generic.go 代码说明文档

> 文件路径：[nomad/structs/cpucompat_generic.go](file:///d:/claude/nomad/nomad/structs/cpucompat_generic.go)
> 总行数：52 行
> 所属包：`structs`
...
| 方法 | 接收者 | 参数 | 返回值 | 行号 |
|------|--------|------|--------|------|
| `topologyFromLegacyGeneric` | - | `old LegacyNodeCpuResources` | `*numalib.Topology` | [L12](file:///d:/claude/nomad/nomad/structs/cpucompat_generic.go#L12) |
