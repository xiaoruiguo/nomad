...
> 文件路径：[state/schema.go](file:///d:/claude/nomad/nomad/state/schema.go)
> 总行数：1699 行
> 所属包：`state`
...
**签名**：`func GetFactories() SchemaFactories`

**位置**：[L69](file:///d:/claude/nomad/nomad/state/schema.go#L69)
