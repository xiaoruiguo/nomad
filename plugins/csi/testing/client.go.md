...
| `GetPluginCapabilities` | `f *IdentityClient` | `ctx context.Context, in *csipbv1.GetPluginCapabilitiesRequest, opts ...grpc....` | `*csipbv1.GetPluginCapabilitiesResponse, error` | [L40](file:///d:/claude/nomad/plugins/csi/testing/client.go#L40) |
...
| `ControllerGetCapabilities` | `c *ControllerClient` | `ctx context.Context, in *csipbv1.ControllerGetCapabilitiesRequest, opts ...g...` | `*csipbv1.ControllerGetCapabilitiesResponse, error` | [L87](file:///d:/claude/nomad/plugins/csi/testing/client.go#L87) |
| `ControllerPublishVolume` | `c *ControllerClient` | `ctx context.Context, in *csipbv1.ControllerPublishVolumeRequest, opts ...grp...` | `*csipbv1.ControllerPublishVolumeResponse, error` | [L91](file:///d:/claude/nomad/plugins/csi/testing/client.go#L91) |
| `ControllerUnpublishVolume` | `c *ControllerClient` | `ctx context.Context, in *csipbv1.ControllerUnpublishVolumeRequest, opts ...g...` | `*csipbv1.ControllerUnpublishVolumeResponse, error` | [L95](file:///d:/claude/nomad/plugins/csi/testing/client.go#L95) |
| `ValidateVolumeCapabilities` | `c *ControllerClient` | `ctx context.Context, in *csipbv1.ValidateVolumeCapabilitiesRequest, opts ......` | `*csipbv1.ValidateVolumeCapabilitiesResponse, error` | [L99](file:///d:/claude/nomad/plugins/csi/testing/client.go#L99) |
...
| `CreateSnapshot` | `c *ControllerClient` | `ctx context.Context, in *csipbv1.CreateSnapshotRequest, opts ...grpc.CallOpt...` | `*csipbv1.CreateSnapshotResponse, error` | [L131](file:///d:/claude/nomad/plugins/csi/testing/client.go#L131) |
| `DeleteSnapshot` | `c *ControllerClient` | `ctx context.Context, in *csipbv1.DeleteSnapshotRequest, opts ...grpc.CallOpt...` | `*csipbv1.DeleteSnapshotResponse, error` | [L135](file:///d:/claude/nomad/plugins/csi/testing/client.go#L135) |
...
| `NodeGetCapabilities` | `c *NodeClient` | `ctx context.Context, in *csipbv1.NodeGetCapabilitiesRequest, opts ...grpc.Ca...` | `*csipbv1.NodeGetCapabilitiesResponse, error` | [L172](file:///d:/claude/nomad/plugins/csi/testing/client.go#L172) |
...
| `NodeStageVolume` | `c *NodeClient` | `ctx context.Context, in *csipbv1.NodeStageVolumeRequest, opts ...grpc.CallOp...` | `*csipbv1.NodeStageVolumeResponse, error` | [L180](file:///d:/claude/nomad/plugins/csi/testing/client.go#L180) |
| `NodeUnstageVolume` | `c *NodeClient` | `ctx context.Context, in *csipbv1.NodeUnstageVolumeRequest, opts ...grpc.Call...` | `*csipbv1.NodeUnstageVolumeResponse, error` | [L184](file:///d:/claude/nomad/plugins/csi/testing/client.go#L184) |
| `NodePublishVolume` | `c *NodeClient` | `ctx context.Context, in *csipbv1.NodePublishVolumeRequest, opts ...grpc.Call...` | `*csipbv1.NodePublishVolumeResponse, error` | [L188](file:///d:/claude/nomad/plugins/csi/testing/client.go#L188) |
| `NodeUnpublishVolume` | `c *NodeClient` | `ctx context.Context, in *csipbv1.NodeUnpublishVolumeRequest, opts ...grpc.Ca...` | `*csipbv1.NodeUnpublishVolumeResponse, error` | [L192](file:///d:/claude/nomad/plugins/csi/testing/client.go#L192) |
| `NodeExpandVolume` | `c *NodeClient` | `ctx context.Context, in *csipbv1.NodeExpandVolumeRequest, opts ...grpc.CallO...` | `*csipbv1.NodeExpandVolumeResponse, error` | [L196](file:///d:/claude/nomad/plugins/csi/testing/client.go#L196) |
