...
> 文件路径：[plugins/drivers/utils/utils_unix.go](file:///d:/claude/nomad/plugins/drivers/utils/utils_unix.go)
> 总行数：17 行
> 所属包：`utils`
...
| 方法 | 接收者 | 参数 | 返回值 | 行号 |
|------|--------|------|--------|------|
| `IsUnixRoot` | - | `` | `bool` | [L14](file:///d:/claude/nomad/plugins/drivers/utils/utils_unix.go#L14) |
...
| 文件 | 关系 |
|------|------|
| [utils_windows.go](file:///d:/claude/nomad/plugins/drivers/utils/utils_windows.go) | 同目录源文件 |
