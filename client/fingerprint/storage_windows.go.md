# storage_windows.go 代码说明文档

> 文件路径：[client/fingerprint/storage_windows.go](file:///d:/claude/nomad/client/fingerprint/storage_windows.go)
> 总行数：37 行
> 所属包：`fingerprint`
...
| 方法 | 接收者 | 参数 | 返回值 | 行号 |
|------|--------|------|--------|------|
| `diskInfo` | `f *StorageFingerprint` | `path string` | `volume string, total uint64, err error` | [L18](file:///d:/claude/nomad/client/fingerprint/storage_windows.go#L18) |
