# fingerprint_default.go 代码说明文档

> 文件路径：[client/fingerprint/fingerprint_default.go](file:///d:/claude/nomad/client/fingerprint/fingerprint_default.go)
> 总行数：11 行
> 所属包：`fingerprint`
> 版权：Copyright IBM Corp. 2015, 2026
> 许可证：SPDX-License-Identifier: BUSL-1.1
> Build Tag：`darwin || dragonfly || freebsd || netbsd || openbsd || solaris || windows`
...
| 方法 | 接收者 | 参数 | 返回值 | 行号 |
|------|--------|------|--------|------|
| `initPlatformFingerprints` | - | `fps map[string]Factory` | `` | [L9](file:///d:/claude/nomad/client/fingerprint/fingerprint_default.go#L9) |
