...
> 文件路径：[allocrunner/taskrunner/getter/util_linux.go](file:///d:/claude/nomad/client/allocrunner/taskrunner/getter/util_linux.go)
> 总行数：212 行
> 所属包：`getter`
...
| `filesForVCS` | - | `homeSSHDir string, homeKnownHosts string, etcPasswd string, etcKnownHosts st...` | `[]*landlock.Path` | [L152](file:///d:/claude/nomad/client/allocrunner/taskrunner/getter/util_linux.go#L152) |
