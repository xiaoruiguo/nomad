...
> 文件路径：[client/allocrunner/taskrunner/template/renderer/template_sandbox_default.go](file:///d:/claude/nomad/client/allocrunner/taskrunner/template/renderer/template_sandbox_default.go)
> 总行数：40 行
> 所属包：`renderer`
