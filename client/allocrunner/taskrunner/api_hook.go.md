...
> 文件路径：[client/allocrunner/taskrunner/api_hook.go](file:///d:/claude/nomad/client/allocrunner/taskrunner/api_hook.go)
> 总行数：123 行
> 所属包：`taskrunner`
...
**中文说明**：apiHook 是一个钩子，在特定生命周期节点执行自定义逻辑。
...
| `srv` | `config.APIListenerRegistrar` | 关联的 Server 实例 |
...
| 方法 | 接收者 | 参数 | 返回值 | 行号 |
|------|--------|------|--------|------|
| `newAPIHook` | - | `shutdownCtx context.Context, srv config.APIListenerRegistrar, logger hclog.Lo...` | `*apiHook` | [L45](file:///d:/claude/nomad/client/allocrunner/taskrunner/api_hook.go#L45) |
| `Name` | ` *apiHook` | `` | `string` | [L54](file:///d:/claude/nomad/client/allocrunner/taskrunner/api_hook.go#L54) |
| `Prestart` | `h *apiHook` | `_ context.Context, req *interfaces.TaskPrestartRequest, resp *interfaces.Task...` | `error` | [L58](file:///d:/claude/nomad/client/allocrunner/taskrunner/api_hook.go#L58) |
| `Stop` | `h *apiHook` | `ctx context.Context, req *interfaces.TaskStopRequest, resp *interfaces.TaskSt...` | `error` | [L93](file:///d:/claude/nomad/client/allocrunner/taskrunner/api_hook.go#L93) |
