...
> 文件路径：[state/db_error.go](file:///d:/claude/nomad/client/state/db_error.go)
> 总行数：187 行
> 所属包：`state`
...
**签名**：`func (m *ErrDB) GetAllAllocations() []*structs.Allocation, map[string]error, error`

**位置**：[L38](file:///d:/claude/nomad/client/state/db_error.go#L38)

### GetDeploymentStatus()

**签名**：`func (m *ErrDB) GetDeploymentStatus(allocID string) *structs.AllocDeploymentStatus, error`

**位置**：[L46](file:///d:/claude/nomad/client/state/db_error.go#L46)

### GetNetworkStatus()

**签名**：`func (m *ErrDB) GetNetworkStatus(allocID string) *structs.AllocNetworkStatus, error`

**位置**：[L54](file:///d:/claude/nomad/client/state/db_error.go#L54)

### GetAcknowledgedState()

**签名**：`func (m *ErrDB) GetAcknowledgedState(allocID string) *arstate.State, error`

**位置**：[L66](file:///d:/claude/nomad/client/state/db_error.go#L66)

### GetAllocVolumes()

**签名**：`func (m *ErrDB) GetAllocVolumes(allocID string) *arstate.AllocVolumes, error`

**位置**：[L74](file:///d:/claude/nomad/client/state/db_error.go#L74)

### GetAllocIdentities()

**签名**：`func (m *ErrDB) GetAllocIdentities(_ string) []*structs.SignedWorkloadIdentity, error`

**位置**：[L82](file:///d:/claude/nomad/client/state/db_error.go#L82)

### GetTaskRunnerState()

**签名**：`func (m *ErrDB) GetTaskRunnerState(allocID string, taskName string) *state.LocalState, *structs.TaskState, error`

**位置**：[L86](file:///d:/claude/nomad/client/state/db_error.go#L86)

### GetDynamicPluginRegistryState()

**签名**：`func (m *ErrDB) GetDynamicPluginRegistryState() *dynamicplugins.RegistryState, error`

**位置**：[L110](file:///d:/claude/nomad/client/state/db_error.go#L110)
