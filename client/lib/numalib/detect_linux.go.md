...
> 文件路径：[client/lib/numalib/detect_linux.go](file:///d:/claude/nomad/client/lib/numalib/detect_linux.go)
> 总行数：308 行
> 所属包：`numalib`
...
**中文说明**：Cgroups1 是一个结构体，封装相关数据和状态。
...
**中文说明**：Cgroups2 是一个结构体，封装相关数据和状态。
...
**中文说明**：Fallback 是一个结构体，封装相关数据和状态。
